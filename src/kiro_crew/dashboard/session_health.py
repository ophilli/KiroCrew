...
_TASK_WAIT_STATES: dict[str, str] = {
    ...
    "waiting_infra": HEALTH_WAITING_DEPENDENCY,
    "waiting_dependency": HEALTH_WAITING_DEPENDENCY,
    "waiting_input": HEALTH_WAITING_INPUT,
}
_TASK_QUEUED_STATES: frozenset[str] = frozenset({"queued", "admitted", "retry_wait"})
...
class SessionHealthMonitor:
    ...
    def _queue_section(
        ...
        section["count"] = sum(int(by_state.get(s, 0)) for s in _TASK_QUEUED_STATES)
