...
export function SettingsMultiSelect({ label, description, hint, options, selected, onToggle, bulkActions, summary, searchPlaceholder, disabled, configKey, settingId, onReorder, reorderDisabled, reorderRowLabel }: SettingsMultiSelectProps) {
  const controlId = React.useId()
  return (
    <SettingsField label={label} description={description} hint={hint} configKey={configKey} settingId={settingId} controlId={controlId}>
      <MultiSelect
