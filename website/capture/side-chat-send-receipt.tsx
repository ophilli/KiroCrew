 ...
 * shared ErrorNotice.
 *
 * Query: ?theme=dark|light ?lang=<locale> ?refuse=409|late
 *   late = `/side/turn` never answers, so the transport deadline fires: the
 *          optimistic bubble rolls back, the question is handed back, and a
 *          STANDING "delivery not confirmed" notice tells the user to look
 *          before resending (held until the next submit).
 */
